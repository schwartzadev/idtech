...
public class Day1RPS {
	...
	if(playerChoice == 0){
		...
		if (compChoice == 0){
			System.out.println("You lose. Scissors (" + compChoice + ") beats Rock (" + playerChoice + ")");
		}
		if (compChoice == 1){
			System.out.println("You win. Scissors (" + playerChoice + ") beats Paper (" + compChoice + ")");
		}
		if (compChoice == 2){
