...
public class Jane {
	...
	public static void stats (Jane x) {
		if (x.health <= 0) {
	...
	// Jane v Alex
		public static void battle (Jane player, Alex comp) { 
		...
		// Jane v Jane
		public static void battle (Jane player, Jane comp) { 
			boolean continueBattle = true;
			int move = 0;
			while (continueBattle == true){
				System.out.println("Do you want to (1) attack or (2) recharge?");
		...
		// Jane v Ned
		public static void battle (Jane player, Ned comp) { 
			boolean continueBattle = true;
			int move = 0;
			while (continueBattle == true){
				System.out.println("Do you want to (1) attack or (2) recharge?");
